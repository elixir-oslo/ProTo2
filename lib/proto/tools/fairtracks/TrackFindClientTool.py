...
import gsuite.GSuiteUtils as GSuiteUtils
from gsuite.GSuite import GSuite
from proto.HtmlCore import HtmlCore
from trackfind.TrackFindModule import TrackFindModule
...
class TrackFindClientTool(GeneralGuiTool):
    ...
    def getInputBoxNames(cls):
        ...
        for i in range(cls.MAX_NUM_OF_LEVELS):
    ...
    def getOptionsBoxFairtracks(cls):
        ...
        core.image('static/images/fairtracks.png',
                   style="display: block; margin: 20px auto 20px 0")
        core.divider()
